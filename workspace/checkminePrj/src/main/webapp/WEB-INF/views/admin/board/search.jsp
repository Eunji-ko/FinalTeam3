        ...
        <main class="shadow">
            ...
            <div id="pageArea">
                <c:if test="${pv.startPage ne 1}">
                    <a href="${root}/admin/board/search?option=${option}&keyword=${keyword}&p=${pv.startPage -1}">&lt;</a>            
                </c:if>
                <c:forEach begin="${pv.startPage}" end="${pv.endPage}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="${root}/admin/board/search?option=${option}&keyword=${keyword}&p=${i}">${i}</a>            
                        </c:otherwise>
                    </c:choose> 
                </c:forEach>
                <c:if test="${pv.endPage ne pv.maxPage}">
                    <a href="${root}/admin/board/search?option=${option}&keyword=${keyword}&p=${pv.endPage + 1}">&gt;</a>
                </c:if>
            </div>
        </main>
    </div>
