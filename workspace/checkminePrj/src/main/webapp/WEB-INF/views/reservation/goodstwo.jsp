                    ...
                    <table class="table">
                      ...
                      <div id="page-btn">
                        ...
                        <c:if test="${pv.startPage ne 1}">
                            <button onclick="location.href='${rootPath}/reservation/goodstwo/${pv.startPage - 1}'" type="button" class="btn btn-sm">&lt;</button>
                        </c:if>
                        ...
                        <c:if test="${pv.endPage ne pv.maxPage}">
                            <button onclick="location.href='${rootPath}/reservation/goodstwo/${pv.endPage + 1}'" type="button" class="btn btn-sm">&gt;</button>
                        </c:if>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="type">
                            ...
                            <select id="name" name="name" class="form-select form-select-sm" aria-label=".form-select-sm example">
                                <option>--선택--</option>
                                <c:forEach items="${voCarList}" var="vo">
