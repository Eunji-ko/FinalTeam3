	...
	<div class="d-flex">
        ...
        <main class="shadow">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="${rootPath}/board/list/community">커뮤니티</a>
                </li>
                <li class="nav-item">
                ...
                <div id="notice"><br>
                    <div id="searchArea">
                        <select class="form-select" id="filter" name="select" onchange="location.href=this.value">
                            <option>-----</option>
                            <option value="${rootPath}/board/list/community?sort=l&p=1">최신순</option>
                            <option value="${rootPath}/board/list/community?sort=r&p=1">추천순</option>
                        </select>
