...
<body>
	<div class="d-flex">
        ...
        <main class="shadow">
            ...
            <div id="infoWrap">
                <form action="${rootPath}/board/write" name="form" method="post" enctype="multipart/form-data" onSubmit="return Checkform();">
                    ...
                    <div id="content-box">
                        ...
                        <div id="footer">
                            ...
                            <div id="buttonArea">
                                <button type="submit" class="btn" id="regist">등록하기</button>
                            </div>
                        </div>
                    </div>
                </form> 
